...
class GoalSearchDT
{
    ...
    private int empty_goal_empty_back(Side side, ulong gbit, bitix gix, int enemyoffset,
    ...
    private int empty_goal_myrabbit_back(Side side, ulong gbit, bitix gix, int enemyoffset,
            int myrabbit, int erabbit, ulong back_bit, ulong rabbit_mask, ulong bneighbors)
    {
        int shortest_goal = NOT_FOUND;
        if (back_bit & ~start.frozen)
    ...
    private int empty_goal(ulong gbit, Side side)
    {
        ...
        {
            return empty_goal_empty_back(side, gbit, gix, enemyoffset,
                    myrabbit, erabbit, back_bit, rabbit_mask, bneighbors);
        }
        else if (back_bit & start.bitBoards[myrabbit])
        {
            return empty_goal_myrabbit_back(side, gbit, gix, enemyoffset,
                    myrabbit, erabbit, back_bit, rabbit_mask, bneighbors);
